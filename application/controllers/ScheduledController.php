        ...
        try{
            do
            {
                ...
                foreach ($product_list_data as $product_data){
                    ...
                    $productFilter_model->feature2                  =   '';
                    $productFilter_model->feature3                  =   '';
                    $productFilter_model->feature4                  =   '';
                    $productFilter_model->feature5                  =   '';
                    $productFilter_model->colour                    =   '';
                    $productFilter_model->size                      =   '';
                    $productFilter_model->factory_url               =   '';
                    $productFilter_model->package_content           =   '';
                    ...
                    $productFilter_model->list_price                =   '';
                    $productFilter_model->num_of_parcel             =   '';
                    $productFilter_model->datafeed_line_end         =   '';
                    $productFilter_model->code                      =   '';
                    $productFilter_model->title                     =   '';
                    $productFilter_model->rro                       =   '';
                    $productFilter_model->dimension                 =   '';
                    $productFilter_model->description               =   $product_data['Description'];
                    $productFilter_model->supplier_code             =   '';
